...
verwendet ausschließlich die öffentliche HTTPS-Adresse der passenden
AIDA-Installation. Die versionierte NDJSON-API von AIDA und der Antwortstrom des
CRM senden während langer Modellläufe regelmäßig Heartbeats.
